...
Instructions
------------
1. Run your search query in wos.
...
4. Then ingest them:
   python -m tools.slr_toolkit.cli ingest --run-folder "C:\Users\t-vwallerich\OneDrive - Microsoft\Quantum\SLR\quantum-finance-slr\03_raw_exports\2026-03-08_wos"
