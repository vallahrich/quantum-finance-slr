...
Instructions
------------
1. Run your search query in semantic_scholar.
...
4. Then ingest them:
   python -m tools.slr_toolkit.cli ingest --run-folder "C:\Users\t-vwallerich\OneDrive - Microsoft\Quantum\SLR\quantum-finance-slr\03_raw_exports\2026-03-10-v3_semantic_scholar"
5. **PRISMA-S mandatory:** update 02_search_logs/search_log.xlsx with:
   ...
   - DateLimits: e.g. 2016-01-01 to 2026-03-10-v3
