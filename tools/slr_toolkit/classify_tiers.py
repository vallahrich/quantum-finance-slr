...
SYSTEM_PROMPT = (
    ...
    "Papers providing broad landscape coverage. Reviews, surveys, position papers, "
    "and high-level introductions.\n"
    "Classify here if: (1) the paper is a review/survey covering multiple use cases; "
    "(2) it discusses QC-in-finance at a landscape level; (3) its main contribution is "
    "benchmarking/advantage assessment across multiple use cases; (4) it describes the "
    "QC industry or financial methods without proposing a specific solution.\n"
